...
public class CorruptorBlockItemModel extends GeoModel<CorruptorBlockItem> {
  ...
  @Override
  public void setCustomAnimations(CorruptorBlockItem animatable, long instanceId,
      AnimationState<CorruptorBlockItem> animationState) {
    ...
    // For the block item, we'll use the player's position as the reference point
